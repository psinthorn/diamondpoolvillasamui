...
class FacilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post facilities_url, params: { facility: { description: @facility.description, main_img: @facility.main_img, name: @facility.name, status: @facility.status, thumb_img: @facility.thumb_img } }
    end
  ...
  test "should update facility" do
    patch facility_url(@facility), params: { facility: { description: @facility.description, main_img: @facility.main_img, name: @facility.name, status: @facility.status, thumb_img: @facility.thumb_img } }
